...
import com.ecirstea.creepyrabbit.utils.Constants.HUMANS_CATEGORY
import kotlinx.android.synthetic.main.fragment_humans_category.*

class HumansCategoryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_humans_category, container, false)
    }
    ...
    private fun observeData () {
        ...
        viewModel.getAudiosByCategory(HUMANS_CATEGORY).observe(viewLifecycleOwner, {
