...
import com.ecirstea.creepyrabbit.utils.Constants.RULES_CATEGORY
import kotlinx.android.synthetic.main.fragment_rules_category.*


class RulesCategoryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_rules_category, container, false)
    }
    ...
    private fun observeData () {
        ...
        viewModel.getAudiosByCategory(RULES_CATEGORY).observe(viewLifecycleOwner, {
